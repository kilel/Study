...
${OBJECTDIR}/CRCAlgorithm.o: CRCAlgorithm.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/CRCAlgorithm.o CRCAlgorithm.cpp

${OBJECTDIR}/MD5Algorithm.o: MD5Algorithm.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/MD5Algorithm.o MD5Algorithm.cpp
